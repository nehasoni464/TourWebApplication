...
const Winter = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:4000/winter?sortBy=${sortBy}&search=${search}`)
      .then((response) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(Winter);
